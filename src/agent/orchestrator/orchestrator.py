"""Cloud Cost Optimization Agent — Agent Orchestrator (Plan → Research → Execute → Validate → Respond)."""
...
class AgentOrchestrator:
    """Orchestrates the Cloud Cost Optimization Agent through a multi-step pipeline.
