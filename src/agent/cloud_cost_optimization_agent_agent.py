"""Cloud Cost Optimization Agent - Main Agent Implementation."""
...
class CloudCostOptimizationAgentAgent:
    """
    ...
    def __init__(self):
        ...
        self.waste_detection_enabled = True
        self.rightsizing_enabled = True
        self.reservation_planning_enabled = True
        self.budget_enforcement_enabled = True
        self._tool_dispatch = {
            "analyze_spending": self.tools.analyze_spending,
            "detect_waste": self.tools.detect_waste,
            "recommend_rightsizing": self.tools.recommend_rightsizing,
            "plan_reservations": self.tools.plan_reservations,
            "enforce_budget": self.tools.enforce_budget,
            "generate_cost_report": self.tools.generate_cost_report,
        }
        logger.info(
            "agent_initialized",
            ...
            features=['cost_analysis', 'waste_detection', 'rightsizing', 'reservation_planning', 'budget_enforcement'],
        )
    ...
    async def _maybe_execute_tools(self, message: str, context: str) -> list[dict]:
        ...
        tool_keywords = {
            ...
            "recommend_rightsizing": ['recommend', 'rightsizing'],
            "plan_reservations": ['plan', 'reservations'],
            "enforce_budget": ['enforce', 'budget'],
